...
public class GameState {
	...
	public void paintDefaults(Graphics g) {
		...
		if (state.equals("TITLE")) {
			...
			// g.drawRect(690, 640, 220, 50);
			else if (subState.equals("findnumplayers")) {
		...
		// RULES SCREEN
			...
			if (subState.equals("page1")) {
				...
				g.drawString(
						...
						1500 / 30, 11 * (950 / 29));
				g.drawImage(perimBrick, 8 * 1500 / 15 + 10, 5 * (950 / 29) - 10, 3 * (1500 / 60), 4 * (950 / 27), null);
				g.drawImage(perimGrain, 9 * 1500 / 15 + 10, 5 * (950 / 29) - 10, 3 * (1500 / 60), 4 * (950 / 27), null);
				g.drawImage(perimStone, 10 * 1500 / 15 + 10, 5 * (950 / 29) - 10, 3 * (1500 / 60), 4 * (950 / 27),
						null);
				g.drawImage(perimSheep, 11 * 1500 / 15 + 10, 5 * (950 / 29) - 10, 3 * (1500 / 60), 4 * (950 / 27),
						null);
				g.drawImage(perimWood, 12 * 1500 / 15 + 10, 5 * (950 / 29) - 10, 3 * (1500 / 60), 4 * (950 / 27), null);
				...
				g.drawString("All cities and settlements, barring the first two, must be connected by roads.",
						4 * (1500 / 15), 19 * 950 / 29);
				g.drawImage(buildButton, 1500 / 15, 26 * (950 / 60) + 20, 181, 59, null);
